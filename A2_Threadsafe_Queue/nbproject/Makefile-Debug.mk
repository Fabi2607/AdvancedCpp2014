...
${OBJECTDIR}/singlethreaded.o: singlethreaded.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/singlethreaded.o singlethreaded.cpp

${OBJECTDIR}/threadsafe_queue.o: threadsafe_queue.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/threadsafe_queue.o threadsafe_queue.cpp
