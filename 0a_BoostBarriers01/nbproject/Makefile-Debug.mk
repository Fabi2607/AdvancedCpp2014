...
LDLIBSOPTIONS=-lpthread -lboost_log -lboost_log_setup -lboost_thread -lboost_system
...
${OBJECTDIR}/barrier01.o: barrier01.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/barrier01.o barrier01.cpp
